  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-120">
        ...
        <input required onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Email adderss' />
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flew-row">
          ...
          <div className="w-full text-end mt-8">
            <button type='submit' className="bg-black text-white  rounded-2xl px-16 py-3 text-sm">PLACE ORDER</button>
          </div>
